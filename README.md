...
* **Pytorch**
  ...
  * "Define by Run"
  * 研究開発界隈では人気上昇中、とのこと。最新の論文をもとにしたモデルは、ここ最近はこの Pytorch での実装がいちばん早い、とも。
...
1. 機械学習の理論の学習
    ...
    * こちらのページに、当書籍の章構成と、そこで学習すべきポイントを記載。
      * [はじめてのディープラーニング -Pythonで学ぶニューラルネットワークとバックプロパゲーション- (Machine Learning)](./book/hajimeteno-deep-learning.md)
　
